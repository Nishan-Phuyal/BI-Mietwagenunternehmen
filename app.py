...
with col2:
    ...
    st.markdown("Die Karte zeigt die Fahrtrouten der Fahrtaufträge am ausgewählten Datum. Die grüne Markierung steht für die Abholadresse, die rote für das Ziel.")
